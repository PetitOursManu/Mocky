...
export const project = {
  fr: {
    ...
    'project.autoLinkFor': 'Analysera « {name} » et proposera des liens vers les autres écrans.',
    'project.autoLinkPickOne': 'Sélectionnez un écran sur le canevas pour l’analyser.',
  ...
  en: {
    ...
    'project.autoLinkFor': 'Will read “{name}” and suggest links to the other screens.',
    'project.autoLinkPickOne': 'Select one screen on the canvas to read it.',
