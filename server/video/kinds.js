...
export const MOTION_KIND_SPECS = {
  ...
  globe: {
    ...
    grounds: ['solid', 'gradient', 'hairlines', 'particles', 'aurora'],
    signature: ['globe'],
    aspectRatio: '16:9',
    scenes: { min: 1, max: 3 },
  ...
  mark: {
    ...
    blocks: ['logoType', 'extrudedType', 'funTitle', 'kicker', 'separator', 'solidScene'],
    grounds: ['solid', 'gradient', 'hairlines', 'particles', 'mesh', 'aurora'],
